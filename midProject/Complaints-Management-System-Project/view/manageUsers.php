 ...
 <table border=1>
    ...
    <?php   for($i=0; $i<count($users); $i++){ ?>
            <tr>
                ...
                <td>
                <a href="../controller/manageUserCheck.php?id=<?= urlencode($users[$i]['id']) ?>&update=true"> Update </a> |
                <a href="../controller/manageUserCheck.php?id=<?= urlencode($users[$i]['id']) ?>&delete=true"> DELETE </a>
                </td>
            </tr>
        <?php } ?>            
        </table>
